  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.25) 40%, rgba(0,0,0,0) 100%)",
        }}
      />

      {/* Bottom fade into next section (#565A60) for smooth blend */}
      <div
        className="absolute inset-x-0 bottom-0 h-40 pointer-events-none z-10"
        style={{
          background:
            "linear-gradient(to bottom, rgba(86,90,96,0) 0%, rgba(86,90,96,0.6) 60%, rgba(86,90,96,1) 100%)",
        }}
      />
        ...
        <div className="flex flex-col items-center gap-y-8 md:gap-y-16 max-w-3xl mx-auto text-center">
          <div>
            ...
            <p className="text-foreground text-base md:text-lg max-w-xl mx-auto font-body">
              <span className="text-white font-semibold">Practical, realistic, pressure tested self-defence training designed for real-life violence, not sport, not fantasy.</span>
            </p>
          </div>
